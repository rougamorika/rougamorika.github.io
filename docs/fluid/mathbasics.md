...
我们现在来描述矢量场的几何情况.这是通过矢量线,它是经过场内各个点的**曲线族**,并且满足**过场内所有点的矢量方向与矢量线处处相切**.
...
$$
\frac{\mathrm{d}x}{a_{x}(x,y,z,t)}=\frac{\mathrm{d}y}{a_{y}(x,y,z,t)}=\frac{\mathrm{d}z}{a_{z}(x,y,z,t)}
$$
这便是矢量线的微分方程,通过对微分方程的求解我们可以得到矢量线的函数.
