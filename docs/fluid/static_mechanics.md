...
![[Pasted image 20250304090259.png|500]]
...
![[Pasted image 20250304092905.png|450]]
...
$$
\textcolor{pink}{\hat{f_{p}}}+\textcolor{yellow}{\hat{f_{grav}}}+\textcolor{cyan}{\hat{f_{visc}}}=\frac{m}{V}\hat{a}
$$
那么我们自然有$\rho=\frac{m}{V}$
所以我们就有:
$$
\textcolor{pink}{\hat{f_{p}}}+\textcolor{yellow}{\hat{f_{grav}}}+\textcolor{cyan}{\hat{f_{visc}}}=\textcolor{lightgreen}{\rho\hat{a}}
$$
## 仅重力作为外力的流体静力学状态
...
\end{cases}
$$
这就是我们平时用来算大气压的公式了,有一个对比的习题:[[等温模型的拟合程度]]
...
![[Pasted image 20250306155439.png]]
