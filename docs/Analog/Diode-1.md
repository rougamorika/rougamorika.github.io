...
![[Pasted image 20250303132902.png|550]]
丢失了一般波形的电路能有什么用呢,我们用Multisim绘制一个这样的电路图,你就明白了.

![[Pasted image 20250303134226.png|550]]
...
*那么古尔丹,代价是什么呢?*
我们**损失了一半的波形**,即我们的脉动直流电的频率只有原来的一半,我们也损失了一半的能量.而且,**脉动直流还是不能用**的,得进一步滤波才能变成我们常用的直流(并一个电容/串一个电感,之后会说.)
...
![[Pasted image 20250303140921.png|450]]
