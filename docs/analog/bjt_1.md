...
上面在讲BJT的放大属性的时候,我们其实就已经有机地谈到了这个问题.下面是BJT管的几种主要的接法

- CE 接法(Common-Emitter),即共发射极放大电路接法
- CB 接法(Common-Base),即共基极放大电路接法
- CC 接法(Common-Collector),即共集电极放大电路接法
